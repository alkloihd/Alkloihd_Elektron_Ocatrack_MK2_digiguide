...
<div class="video-callout">
  <p><strong>Watch this explained:</strong>
  ...
  fetch('../data/videos.json')
    ...
    .then(videos => {
      const related = videos.filter(v =>
        v.relevantTutorials.includes(tutorialId)
      );
      // Render cards
    });
</script>
